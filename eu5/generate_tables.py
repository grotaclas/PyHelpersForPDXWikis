...
! [[File:''', 1)
    ...
    def generate_advances_table(self):
        ...
        advances_table_data = [{
            ...
            'Ai Weight': '' if advances.ai_weight is None else self.create_wiki_list(['{k}: ...' for ai_weight in advances.ai_weight.keys()]) if advances.ai_weight else '',  # ai_weight: <class 'common.paradox_parser.Tree'>
    ...
    def generate_cabinet_actions_table(self):
        ...
        cabinet_actions_table_data = [{
            ...
            'Ability': cabinet_actions.ability.get_wiki_link_with_icon() if cabinet_actions.ability else '',  # ability: <class 'eu5.eu5lib.Eu5GameConcept'>
            ...
            'Map Marker': '' if cabinet_actions.map_marker is None else self.create_wiki_list(['{k}: ...' for map_marker in cabinet_actions.map_marker.keys()]) if cabinet_actions.map_marker else '',  # map_marker: <class 'common.paradox_parser.Tree'>
            ...
            'Select Trigger': '' if cabinet_actions.select_trigger is None else cabinet_actions.select_trigger,  # select_trigger: typing.Any
    ...
    def generate_cultures_table(self):
        culturess = self.parser.cultures.values()
        cultures_table_data = [{
            'Name': f' style="background-color: {cultures.color.get_css_color_string()}" | ' + f'{{{{iconbox|{cultures.display_name}|{cultures.description}|w=300px|image={cultures.get_wiki_filename()}}}}}',
            ...
            'Language': cultures.language if isinstance(cultures.language, str) else cultures.language.get_wiki_link_with_icon() if cultures.language else '',  # language: <class 'eu5.eu5lib.Language'>
            ...
            'Opinions': '' if cultures.opinions is None else self.create_wiki_list(['{k}: ...' for opinions in cultures.opinions.keys()]) if cultures.opinions else '',  # opinions: <class 'common.paradox_parser.Tree'>
    ...
    def generate_holy_sites_table(self):
        ...
        holy_sites_table_data = [{
            'Name': f'{{{{iconbox|{holy_sites.display_name}|{holy_sites.description}|w=300px|image={holy_sites.get_wiki_filename()}}}}}',
            ...
            'Location': holy_sites.location.get_wiki_link_with_icon() if holy_sites.location else '',  # location: <class 'eu5.eu5lib.Location'>
    ...
    def generate_languages_table(self):
        ...
        languages_table_data = [{
            'Name': f' style="background-color: {languages.color.get_css_color_string()}" | ' + f'{{{{iconbox|{languages.display_name}|{languages.description}|w=300px|image={languages.get_wiki_filename()}}}}}',
            ...
            'Dialects': '' if languages.dialects is None else self.create_wiki_list(['{k}: ...' for dialects in languages.dialects.keys()]) if languages.dialects else '',  # dialects: <class 'common.paradox_parser.Tree'>
            ...
            # 'Fallback': '' if languages.fallback is None else languages.fallback.get_wiki_link_with_icon() if languages.fallback else '',  # fallback: <class 'eu5.eu5lib.Language'>
    ...
    def generate_levies_table(self):
        ...
        levies_table_data = [{
            'Name': f'{{{{iconbox|{levies.display_name}|{levies.description}|w=300px|image={levies.get_wiki_filename()}}}}}',
            ...
            'Allowed Culture': self.create_wiki_list([allowed_culture.get_wiki_link_with_icon() if allowed_culture else '' for allowed_culture in levies.allowed_culture]),  # allowed_culture: list[eu5.eu5lib.Culture]
    ...
    def generate_parliament_agendas_table(self):
        ...
        parliament_agendas_table_data = [{
            'Name': f'{{{{iconbox|{parliament_agendas.display_name}|{parliament_agendas.description}|w=300px|image={parliament_agendas.get_wiki_filename()}}}}}',
    ...
    def generate_peace_treaties_table(self):
        ...
        peace_treaties_table_data = [{
            ...
            'Antagonism Type': '' if peace_treaties.antagonism_type is None else peace_treaties.antagonism_type.get_wiki_link_with_icon() if peace_treaties.antagonism_type else '',  # antagonism_type: <class 'eu5.eu5lib.Bias'>
            ...
            'Select Trigger': '' if peace_treaties.select_trigger is None else self.create_wiki_list(['{k}: ...' for select_trigger in peace_treaties.select_trigger.keys()]) if peace_treaties.select_trigger else '',  # select_trigger: <class 'common.paradox_parser.Tree'>
    ...
    def generate_religions_table(self):
        ...
        religions_table_data = [{
            'Name': f' style="background-color: {religions.color.get_css_color_string()}" | ' + f'{{{{iconbox|{religions.display_name}|{religions.description}|w=300px|image={religions.get_wiki_filename()}}}}}',
            ...
            'Group': '' if religions.group is None else religions.group.get_wiki_link_with_icon() if religions.group else '',  # group: <class 'eu5.eu5lib.ReligionGroup'>
            ...
            ' Important Country': '' if religions._important_country is None else religions._important_country,  # _important_country: <class 'str'>
            #cultures.language if isinstance(cultures.language, str) else cultures.language.get_wiki_link_with_icon() if cultures.language else '',  # language: <class 'eu5.eu5lib.Language'>
            'Language': religions.language if isinstance(religions.language, str) else religions.language.get_wiki_link_with_icon() if religions.language else '',  # language: <class 'eu5.eu5lib.Language'>
            ...
            'Opinions': '' if religions.opinions is None else self.create_wiki_list(['{k}: ...' for opinions in religions.opinions.keys()]) if religions.opinions else '',  # opinions: <class 'common.paradox_parser.Tree'>
    ...
    def generate_religious_aspects_table(self):
        ...
        religious_aspects_table_data = [{
            ...
            'Opinions': '' if religious_aspects.opinions is None else self.create_wiki_list(['{k}: ...' for opinions in religious_aspects.opinions.keys()]) if religious_aspects.opinions else '',  # opinions: <class 'common.paradox_parser.Tree'>
    ...
    def generate_subject_types_table(self):
        ...
        subject_types_table_data = [{
            ...
            'Diplo Chance Accept Overlord': '' if subject_types.diplo_chance_accept_overlord is None else self.create_wiki_list(['{k}: ...' for diplo_chance_accept_overlord in subject_types.diplo_chance_accept_overlord.keys()]) if subject_types.diplo_chance_accept_overlord else '',  # diplo_chance_accept_overlord: <class 'common.paradox_parser.Tree'>
            'Diplo Chance Accept Subject': '' if subject_types.diplo_chance_accept_subject is None else self.create_wiki_list(['{k}: ...' for diplo_chance_accept_subject in subject_types.diplo_chance_accept_subject.keys()]) if subject_types.diplo_chance_accept_subject else '',  # diplo_chance_accept_subject: <class 'common.paradox_parser.Tree'>
            ...
            'Type': '' if subject_types.type is None else subject_types.type.get_wiki_link_with_icon() if subject_types.type else '',  # type: <class 'eu5.eu5lib.Eu5GameConcept'>
    ...
    def generate_traits_table(self):
        traits = self.parser.traits.values()
        trait_table_data = [{
            ...
            'Allow': self.formatter.format_trigger(trait.allow),  # allow: <class 'eu5.trigger.Trigger'>
            'Category': trait.category.get_wiki_link_with_icon() if trait.category else '',  # category: <class 'eu5.eu5lib.Eu5GameConcept'>
            'Chance': '' if trait.chance is None else self.create_wiki_list(['{k}: ...' for chance in trait.chance.keys()]) if trait.chance else '',  # chance: <class 'common.paradox_parser.Tree'>
            'Flavor': '' if trait.flavor is None else trait.flavor.get_wiki_link_with_icon() if trait.flavor else '',  # flavor: <class 'eu5.eu5lib.TraitFlavor'>
        } for trait in traits]
    ...
    def generate_unit_types_table(self):
        ...
        unit_types_table_data = [{
            ...
            'Combat': '' if unit_types.combat is None else self.create_wiki_list(['{k}: ...' for combat in unit_types.combat.keys()]) if unit_types.combat else '',  # combat: <class 'common.paradox_parser.Tree'>
            ...
            'Copy From': '' if unit_types.copy_from is None else unit_types.copy_from.get_wiki_link_with_icon() if unit_types.copy_from else '',  # copy_from: <class 'eu5.eu5lib.UnitType'>
            ...
            'Impact': '' if unit_types.impact is None else self.create_wiki_list(['{k}: ...' for impact in unit_types.impact.keys()]) if unit_types.impact else '',  # impact: <class 'common.paradox_parser.Tree'>
            ...
            'Mercenaries Per Location': '' if unit_types.mercenaries_per_location is None else unit_types.mercenaries_per_location,  # mercenaries_per_location: typing.Any
            ...
            'Upgrades To Only': '' if unit_types.upgrades_to_only is None else unit_types.upgrades_to_only.get_wiki_link_with_icon() if unit_types.upgrades_to_only else '',  # upgrades_to_only: <class 'eu5.eu5lib.UnitType'>
    ...
    def generate_wargoals_table(self):
        ...
        wargoals_table_data = [{
            ...
            'Attacker': '' if wargoals.attacker is None else self.create_wiki_list(['{k}: ...' for attacker in wargoals.attacker.keys()]) if wargoals.attacker else '',  # attacker: <class 'common.paradox_parser.Tree'>
            'Defender': '' if wargoals.defender is None else wargoals.defender,  # defender: typing.Any
