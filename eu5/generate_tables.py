...
# 'Town': '[[File:Yes.png|20px|Town]]' if building.town else '[[File:No.png|20px|Not Town]]',  # town: <class 'bool'>
    ...
    def generate_estate_privileges_table(self):
        privileges = self.parser.estate_privileges.values()
        privilege_table_data = [{
            ...
            'Estate': privilege.estate.get_wiki_link_with_icon() if privilege.estate else '',  # estate: <class 'eu5.eu5lib.Estate'>
            'Potential': self.formatter.format_trigger(privilege.potential),  # potential: <class 'eu5.trigger.Trigger'>
            'Allow': self.formatter.format_trigger(privilege.allow),  # allow: <class 'eu5.trigger.Trigger'>
            'Can Revoke': self.formatter.format_trigger(privilege.can_revoke),  # can_revoke: <class 'eu5.trigger.Trigger'>
            'On Activate': self.formatter.format_effect(privilege.on_activate),  # on_activate: <class 'eu5.effect.Effect'>
            'On Fully Activated': self.formatter.format_effect(privilege.on_fully_activated),  # on_fully_activated: <class 'eu5.effect.Effect'>
            'On Deactivate': self.formatter.format_effect(privilege.on_deactivate),  # on_deactivate: <class 'eu5.effect.Effect'>
            'Country Modifier': self.format_modifier_section('country_modifier', privilege),  # country_modifier: list[eu5.eu5lib.Eu5Modifier]
            'Province Modifier': self.format_modifier_section('province_modifier', privilege),  # province_modifier: list[eu5.eu5lib.Eu5Modifier]
            'Location Modifier': self.format_modifier_section('location_modifier', privilege),  # location_modifier: list[eu5.eu5lib.Eu5Modifier]
            'Days': privilege.days,  # days: <class 'int'>
            'Weeks': privilege.weeks,  # weeks: <class 'int'>
            'Months': privilege.months,  # months: <class 'int'>
            'Years': privilege.years,  # years: <class 'int'>
