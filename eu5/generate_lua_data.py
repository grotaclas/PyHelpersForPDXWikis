...
It is autogenerated with https://github.com/grotaclas/PyHelpersForPDXWikis/blob/main/eu5/generate_lua_data.py (parameter modifier_data_lua) and automatically
...
local p = ''' + luadata.serialize(result, indent=' ') + '\n\nreturn p'
    ...
    def generate_named_modifier_data_lua(self):
        ...
        return '''--[[
This module lists all named modifiers from game/main_menu/common/modifiers.
It's meant to be required by "Module:Modifier"

It is autogenerated with https://github.com/grotaclas/PyHelpersForPDXWikis/blob/main/eu5/generate_lua_data.py (parameter named_modifier_data_lua) and automatically
updated. Please note suggestions for changes on the talk page or raise an issue on github, because manual changes will be overwritten.
]]--
local p = ''' + luadata.serialize(result, indent=' ') + '\n\nreturn p'
