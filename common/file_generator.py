...
class FileGenerator:
    ...
    def surround_with_autogenerated_section(self, section_name, contents, generator=name_of_this_tool, add_version_header=False, custom_warning_message: str = None, skip_generator_comment=False):
